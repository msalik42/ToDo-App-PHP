				...
				<div class="task">
					<table>
						...
						<tr>
							...
							<p style="display: inline; font-size: 12px; color: gray">
								&nbsp <?php $datetime = new DateTime('monday');   echo $datetime->format('D j M');?>
							</p>
							<p onclick="disp(this.id)" id=" <?php echo $datetime->format('D j M'); ?> " style="cursor: pointer; color: #E83A57; font-weight: bold;">+ Add Task</p>
						</tr>
						<hr>
			...
			<div id = "body-right">		<!-- body right part -->
				<div>
					<ul style="list-style: none;">
						<li>
							<p onclick="dispPendWork(this.id)" id="today" style="display: inline; cursor: pointer;"><i  class="material-icons">date_range</i>  Today</p>
						</li> 
						<br> <br>
						<li>
							<p onclick="dispPendWork(this.id)" id="sevenday" style="display: inline;  cursor: pointer; "><i  class="material-icons">date_range</i>  Next 7 Days</p>
						</li> 
					</ul>
				</div>
			</div>
